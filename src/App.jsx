...
function App() {
  ...
  // App.jsx ke andar fetchUserCount ko theek karo
  const fetchUserCount = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/auth/total-users`);
      // Backend se { total: count } aa raha hai, count nahi
      ...
      {!userId ? (
        ...
        <div>
          {role === "Admin" && (
            ...
            >
              <h1 style={{ color: "#991b1b", margin: 0 }}>
                👑 Admin Dashboard
              </h1>
              {/* API URL ki jagah userCount state use karo */}
            ...
            >
              ...
              <div style={{ marginTop: "20px" }}>
                ...
                {notes.map((n) => (
                  ...
                  >
                    <span
                      style={{ color: "#444", flex: 1, marginRight: "10px" }}
                    >
                      {n.content}
                    </span>
